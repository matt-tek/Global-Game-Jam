...
vector<string> diner = {{"Elize", "Julia", "Victor", "Elize", "Catherine", "Diego", "Agathe", "Elize", "Carlos", "Victor", "Pablo", "Victor"}};

vector<string> cousin_meet = {{"James", "Diego", "James", "Diego", "James", "Diego", "James"}};

vector<string> bad_meet = {{"Carlos", "Sebastian", "Carlos", "Sebastian", "Carlos", "Sebastian"}};
